    ...
    {{-- <form action=""> --}}
        <div class="filter">
            <div class="waiterFilter">
                <div class="subtitle">  فلتر محاسبين القاعات</div>
                <div class="dateFilter">
                    <label for="filterDate">حسب الوقت</label>
                    <select name="filterDate" id="filterDate" disabled>
                ...
                <div class="nameFilter">
                    ...
                    <input type="text" name="filterName" id="filterName" disabled>
                </div>
            </div>
        </div>
        <div class="waiter">
            <div class="subtitle">محاسبين   القاعات</div>
            <select name="seller" id="waiter">
                <option value="-1"  disabled selected> حدد اسم المحاسب </option>
        ...
        <div class="hall">
            <div class="subtitle"> القاعات</div>
            <div class="cntr">
                @foreach ($salePoints as $salePoint)
                    <label for="{{$salePoint->hallNumber}}" class="radio">
                        <input  type="radio" name="salePoint" value="{{$salePoint->hallNumber}}"  id="{{$salePoint->hallNumber}}" class="hidden halls"/>
                        <span class="label"></span>{{$salePoint->hallName}}
                    </label>
                @endforeach
            </div>
        </div>
        <div class="tables">
            <div class="subtitle">جميع المحاسبين في هذه القاعة</div>
            ...
            function init() {
                ...
                $.ajaxSetup({
                    ...
                    $('.halls').click(function (e) {
                        ...
                        $.ajax({
                            type: "get",
                            url: `get-all-hall-acountants/${$(this).val()}`,
                            success: function (response) {
                                if (response.sellers) {
